...
import com.example.movieapp.adapters.EpisodesAdapter;
import com.example.movieapp.adapters.ImageSliderAdapter;
import com.example.movieapp.databinding.ActivityTvshowDetailsBinding;
import com.example.movieapp.databinding.LayoutEpisodesBottomSheetBinding;
import com.example.movieapp.models.TvShow;
import com.example.movieapp.utilities.TempDataHolder;
import com.example.movieapp.viewmodels.TVShowDetailsViewModel;
        ...
        for(int i = 0; i<childCount;i++){
            ...
            if(i == position){
                imageView.setImageDrawable(
                        ContextCompat.getDrawable(getApplicationContext(), R.drawable.background_slider_indicator_activitie)
                );
